    ...
    >
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto">
          Built for Canadian employers and job seekers, we're showing you
          the top features that make hiring and job searching actually work.
        </p>
      </div>
      <div className="mt-20  grid cols-1 lg:grid-cols-5 gap-4 auto-rows-[25rem] max-w-3xl mx-auto lg:max-w-none">
        ...
        <Card className="flex flex-col relative justify-between lg:col-span-2">
          ...
          <CardContent className="absolute z-10 bottom-0">
            <CardTitle>Smart Hiring Dashboard</CardTitle>
            <CardDescription>
            With real-time applicant tracking, see AI-ranked candidates,
            collaboration tools, and hiring pipeline analytics all in one place.
            </CardDescription>
          </CardContent>
        </Card>
        <Card className="flex flex-col relative justify-between lg:col-span-2 bg-transparent">
          ...
          <div className="absolute z-10 inset-x-0 bottom-0 h-[70%] bg-gradient-to-t from-white via-white to-transparent" />
          <CardContent className="absolute  z-10 bottom-0">
            <CardTitle>Canadian-First Platform</CardTitle>
            <CardDescription>
            Built specifically for Canada with bilingual support, provincial compliance,
            work permit filters, and salary transparency requirements baked in.
            </CardDescription>
          </CardContent>
        ...
        <Card className="flex flex-col justify-between lg:col-span-3">
          ...
          <CardContent className="h-40">
            ...
            <CardDescription>We spent 90% of our effort on UX. Post a job in 3 minutes,
              review AI-ranked candidates instantly,
              and hire faster with an intuitive dashboard.</CardDescription>
          </CardContent>
        </Card>
      </div>
    </div>
