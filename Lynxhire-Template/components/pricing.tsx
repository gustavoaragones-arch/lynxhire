  ...
  return (
    <div id="pricing" className="py-24 px-4 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        Transparent, affordable pricing built for Canadian SMEs. No pay-per-click traps, no hidden fees.
        Just straightforward plans that help you hire quality candidates without breaking the bank.
        </p>
      </div>
