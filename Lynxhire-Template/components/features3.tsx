  ...
  return (
    <SectionWrapper>
      ...
      <SectionTitle
        ...
        description="Generate professional, inclusive job postings in seconds.
        Just input the role and requirements, then edit and publish.."
      />
    </SectionWrapper>
  );
};
  ...
  return (
    <SectionWrapper>
      ...
      <SectionTitle
        ...
        description="We offer straightforward pricing built for Canadian SMEs. No hidden fees,
        no pay-per-click traps, just affordable access to quality candidates."
      />
    </SectionWrapper>
  );
};
  ...
  return (
    <SectionWrapper>
      ...
      <SectionTitle
        ...
        description="With built-in team features, invite hiring managers, share candidate notes,
        use scorecards, and make better hiring decisions together."
      />
    </SectionWrapper>
  );
};
    ...
    <section className="py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          With AI transforming recruitment, we've integrated it where it matters most:
          intelligent matching, smart job descriptions, and automated candidate ranking that actually works.
